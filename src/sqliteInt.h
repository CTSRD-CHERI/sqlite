...
void *sqlite3Malloc(u64) __attribute__((alloc_size(1)));
void *sqlite3MallocZero(u64) __attribute__((alloc_size(1)));
void *sqlite3DbMallocZero(sqlite3*, u64) __attribute__((alloc_size(2)));
void *sqlite3DbMallocRaw(sqlite3*, u64) __attribute__((alloc_size(2)));
void *sqlite3DbMallocRawNN(sqlite3*, u64) __attribute__((alloc_size(2)));
char *sqlite3DbStrDup(sqlite3*,const char*);
char *sqlite3DbStrNDup(sqlite3*,const char*, u64);
void *sqlite3Realloc(void*, u64) __attribute__((alloc_size(2)));
void *sqlite3DbReallocOrFree(sqlite3 *, void *, u64) __attribute__((alloc_size(3)));
void *sqlite3DbRealloc(sqlite3 *, void *, u64) __attribute__((alloc_size(3)));
void sqlite3DbFree(sqlite3*, void*);
void sqlite3DbFreeNN(sqlite3*, void*);
int sqlite3MallocSize(void*);
int sqlite3DbMallocSize(sqlite3*, void*);
void *sqlite3ScratchMalloc(int) __attribute__((alloc_size(1)));
void sqlite3ScratchFree(void*);
void *sqlite3PageMalloc(int) __attribute__((alloc_size(1)));
